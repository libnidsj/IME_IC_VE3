...
Programa em C que implementa um jogo nao-contínuo de perguntas e respostas 
*/
...
int main() { 
	...
	while(1) {
		...
		if(ptr_atual->tipo != terminal) {
			...
			//Ler proximo no e atualizar posicao atual
...
void cadastrar_nos() {
	opcao opcoes_0[5] = {{'A', 1}, {'B', 2}, {'C', 1}, {'D', 1}, {'E', 1}};
	cadastrar_no(0, 
		"\nPERGUNTA 1\nQuem eh o patrono do QEM?\nA - Caxias\nB - Ricardo Franco\nC - Sampaio\nD - Osorio\nE - Mallet\n\nOpcao escolhida: ", 
		nao_terminal, 5, opcoes_0);
	cadastrar_no(1, "Voce nao acertou nenhuma pergunta! ESTUDE MAIS!", terminal, 0, NULL);
	opcao opcoes_2[5] = {{'A', 3}, {'B', 3}, {'C', 3}, {'D', 4}, {'E', 3}};
	cadastrar_no(2, 
		"\nPERGUNTA 2\nEm que dia eh comemorado o dia do QEM?\nA - 19 de abril\nB - 24 de maio\nC - 10 de junho\nD - 3 de agosto\nE - 10 de maio\n\nOpcao escolhida: ",
		nao_terminal, 5, opcoes_2);
	cadastrar_no(3, "Voce acertou apenas 1 pergunta! ESTUDE MAIS!", terminal, 0, NULL);
	cadastrar_no(4, "PARABENS! Voce acertou todas as perguntas!", terminal, 0, NULL);
}
